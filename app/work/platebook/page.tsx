...
function Phone({ tint = "#1C1C1C", screenLabel, src, priority }: { tint?: string; screenLabel?: string; src?: string; priority?: boolean }) {
  return (
  ...
  return (
    <div style={{ fontFamily: "var(--font-inter), sans-serif", backgroundColor: T.light, color: T.mid }}>
      ...
      {/* Responsive grid helpers — inline styles can't respond to media queries,
          so column templates live here and collapse on narrow screens */}
      <style>{`
        .pb-cols-2 { grid-template-columns: 1fr 1fr; }
        .pb-cols-4 { grid-template-columns: repeat(4, 1fr); }
        .pb-hero   { grid-template-columns: 1fr clamp(280px, 38%, 400px); }
        @media (max-width: 880px) {
          .pb-cols-2, .pb-hero { grid-template-columns: 1fr; }
          .pb-cols-4 { grid-template-columns: 1fr 1fr; }
        }
      `}</style>
        ...
        <div className="pb-hero" style={{
          ...
          <HeroTextParallax rate={0.10}>
            ...
            <p style={{
              ...
              A meal tracking app built for your daily routines.
            </p>
            ...
            <p style={{
              ...
              Build a library of the meals you eat on a regular basis. Log them in one touch and let PlateBook figure out the rest.
            </p>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <Phone src="/pb-home.avif" screenLabel="Home screen: calories & protein donut charts" tint="#1C1C1C" priority />
          </div>
        </div>

        {/* Role strip */}
        <div className="pb-cols-4" style={{
          position: "relative", zIndex: 1,
          display: "grid",           gap: "1px", backgroundColor: "rgba(255,255,255,0.07)",
      ...
      <section style={{
        ...
        <AnimateIn delay={0.1}>
          <div className="pb-cols-2" style={{ display: "grid", gap: "1px", backgroundColor: "rgba(13,27,62,0.08)" }}>
            ...
            <div style={{ padding: "3rem 2.5rem", backgroundColor: T.mid, borderTop: `3px solid ${T.amber}`, display: "flex", flexDirection: "column" as const, gap: "1.25rem" }}>
              ...
              <p style={{ fontFamily: T.serif, fontSize: "clamp(1.4rem,2.2vw,1.9rem)", color: "#fff", lineHeight: 1.25 }}>
                Tracking meals<br /><em>shouldn't</em> be a chore.
              </p>
              <p style={{ fontSize: "clamp(0.9rem,1.05vw,1rem)", color: "rgba(255,255,255,0.5)", lineHeight: 1.85 }}>
                Some apps ask you to scan barcodes, weigh ingredients, and record each meal from scratch each time. Other apps ask you to take pictures of your meal and can only <em>guess</em> the nutritional information. Most people quit within a week.
              </p>
            </div>
            ...
            <div style={{ padding: "3rem 2.5rem", backgroundColor: T.light, borderTop: `3px solid ${T.amber}`, display: "flex", flexDirection: "column" as const, gap: "1.25rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", borderLeft: `3px solid ${T.amber}`, paddingLeft: "1.25rem" }}>
                ...
                <div>
                  <p style={{ fontSize: "clamp(0.85rem,1vw,0.95rem)", color: T.mid, lineHeight: 1.55 }}>
                    meals is the average adult's weekly rotation.
                  </p>
              ...
              <p style={{ fontSize: "clamp(0.9rem,1.05vw,1rem)", color: T.muted, lineHeight: 1.85 }}>
                PlateBook leans into that. Save your meals once, log them in a tap, and let a context-aware engine do the heavy lifting.
              </p>
            </div>
      ...
      <section style={{ backgroundColor: T.ink, paddingTop: T.padY, paddingBottom: T.padY, paddingLeft: T.padX, paddingRight: T.padX }}>
        <AnimateIn>
          ...
          <H2 dark>Your Day in One Screen</H2>
        </AnimateIn>

        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(2.5rem, 5vw, 6rem)", alignItems: "center" }}>
          <AnimateIn delay={0.05}>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: "clamp(1.1rem, 2.2vw, 2rem)" }}>
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "1.5rem" }}>
                {[
                  { title: "Greeting that rotates daily", body: "Encouraging greetings that change each day. Inspired by Duolingo's motivation mechanics." },
                  { title: "Swipe to remove", body: "Swipe left on any logged meal to delete it. Easy peasy." },
                  { title: "Live progress trackers", body: "Remaining calories and protein update in real time. Pill badges go red near the limit." },
                ].map(({ title, body }) => (
          ...
          <AnimateIn delay={0.15}>
            <PhoneTiltWrapper>
              <Phone src="/pb-home.avif" screenLabel="Home: donut charts, today's meal log" tint="#1C1C1C" />
            </PhoneTiltWrapper>
          </AnimateIn>
        </div>
      </section>
      ...
      <section style={{ paddingTop: T.padY, paddingBottom: T.padY, paddingLeft: T.padX, paddingRight: T.padX }}>
        <AnimateIn>
          ...
          <H2>PlateBook Knows You. And What You're Craving.</H2>
        </AnimateIn>

        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(2.5rem, 5vw, 6rem)", alignItems: "center" }}>
          <AnimateIn delay={0.05}>
            <PhoneTiltWrapper>
              <Phone src="/pb-suggestions.avif" screenLabel="Suggestions: meal picks with reasoning" tint="#f9f9f9" />
            </PhoneTiltWrapper>
          </AnimateIn>
          <AnimateIn delay={0.15}>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: "clamp(1.5rem, 3vw, 2.5rem)" }}>
              <p style={{ fontSize: "clamp(0.9rem, 1.05vw, 1rem)", color: T.muted, lineHeight: 1.85 }}>
                PlateBook's engine ranks your playbook meals by protein density, how much of your remaining gap they cover, and how often you've eaten them at around this time of day.
              </p>
              <div style={{ border: `1px solid rgba(13,27,62,0.1)`, borderTop: `3px solid ${T.amber}`, padding: "1.75rem 2rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.85rem" }}>
                  {[
                    { factor: "Protein density", note: "higher ratio of protein ÷ calories -> higher score" },
                    { factor: "Protein coverage", note: "will this meal help you meet your daily goal?" },
                    { factor: "Time-of-day boost", note: "meals you eat at the same time of day score up to 2.5×" },
                  ].map(({ factor, note }, i) => (
      ...
      {/* ── FEATURE 3: PLAYBOOK ─────────────────────────────────── */}
      <section style={{ backgroundColor: T.ink, paddingTop: T.padY, paddingBottom: T.padY, paddingLeft: T.padX, paddingRight: T.padX }}>
        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(2.5rem, 5vw, 6rem)", alignItems: "start" }}>
          <AnimateIn>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: "clamp(1.5rem, 3vw, 2.5rem)" }}>
              <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", backgroundColor: "rgba(255,255,255,0.06)" }}>
                {[
                  ...
                  { title: "Smart Search", body: "Searches for meal name and individual ingredients" },
                  { title: "Usage Count", body: "Every log tap increments a counter on the card" },
                  { title: "P/C Ratio Badge", body: "Protein efficiency shown easily on every card" },
                  { title: "Serving Scale", body: "Adjust serving size; macros preview updates live" },
                  { title: "Swipe to Delete", body: "Swipe left to remove. Easy peasy!" },
                ].map(({ title, body }) => (
          ...
          <AnimateIn delay={0.1}>
            <div className="pb-cols-2" style={{ display: "grid", gap: "1.5rem", alignItems: "start" }}>
              <PhoneTiltWrapper>
                <Phone src="/pb-playbook.avif" screenLabel="Playbook: meal cards with macro pills, P/C ratio" tint="#f9f9f9" />
              </PhoneTiltWrapper>
      ...
      <section style={{
        ...
        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(2.5rem, 5vw, 6rem)", alignItems: "center" }}>
          <AnimateIn delay={0.05}>
            <PhoneTiltWrapper>
              <Phone src="/pb-analytics.avif" screenLabel="Analytics: monthly calendar, streak, trend charts" tint="#1C1C1C" />
            </PhoneTiltWrapper>
          </AnimateIn>
          <AnimateIn delay={0.15}>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: "1.25rem" }}>
                {[
                  { title: "Goal-aware marking", body: "Cut/recomp -> under limit. Bulk -> hit minimum. Maintain -> within 10%." },
                  { title: "Streak counter", body: "Consecutive days with both goals met. Retention hook inspired by Duolingo and Finch." },
                  { title: "Monthly trend lines", body: "Calories and protein charted over time." },
      ...
      <section style={{
        ...
        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(3rem, 6vw, 6rem)" }}>
          {/* Colour */}
          <AnimateIn delay={0.05}>
          ...
          <AnimateIn delay={0.1}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: "2rem" }}>
              <div style={{ borderLeft: `3px solid ${T.amber}`, paddingLeft: "1.5rem" }}>
                <p style={{ fontSize: "clamp(1.6rem, 2.5vw, 2.2rem)", color: T.mid, fontWeight: 800, letterSpacing: "2px", marginBottom: "0.3rem", lineHeight: 1 }}>MILKER BOLD</p>
      ...
      {/* ── WHAT'S NEXT ─────────────────────────────────────────── */}
      <section style={{ backgroundColor: T.ink, paddingTop: T.padY, paddingBottom: T.padY, paddingLeft: T.padX, paddingRight: T.padX }}>
        <div className="pb-cols-2" style={{ display: "grid", gap: "clamp(3rem, 6vw, 7rem)", alignItems: "center", maxWidth: 1200 }}>
          <AnimateIn>
            ...
            <p style={{ fontSize: "clamp(0.95rem, 1.1vw, 1.05rem)", color: "rgba(255,255,255,0.5)", lineHeight: 1.9 }}>
              A curated set of playbook entries for a specific goal. Users can export as a file and import in one tap. This would solve the struggle with cold-starting a new diet and let people easily share what's working for them.
            </p>
          </AnimateIn>
          <AnimateIn delay={0.1}>
            <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.3)", marginBottom: "0.75rem" }}>
      ...
      <section style={{ backgroundColor: T.light, paddingTop: T.padY, paddingBottom: T.padY, paddingLeft: T.padX, paddingRight: T.padX }}>
        ...
        <AnimateIn delay={0.05}>
          <div className="pb-cols-2" style={{
            ...
            <div>
              <p style={{ fontSize: "clamp(0.9rem, 1.05vw, 1rem)", color: T.muted, lineHeight: 1.85 }}>
                A companion app applying the same one-tap logging model to glucose management. Tracks daily carbs and fiber intake against. Designed for health-conscious users and those managing prediabetes. Inspired by my loved ones. Built on the same stack with a distinct pink visual identity.
              </p>
            </div>
          </div>
        </AnimateIn>
      ...
      <section style={{
        ...
        <Link href="/work/loreal-brandstorm" style={{ textDecoration: "none" }}>
